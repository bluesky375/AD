...
class Constants {
    struct  URL {
        ...
        static let ipAddress =  "http://www.erononline.com/"
    ...
    struct customCodes {
        //Live
        static let purchaseCode = "c3560248-6c5a-4cb6-b1e9-2a68debfec84"
        static let securityCode = "123456789"
    }
    
    struct googlePlacesAPIKey {
        static let placesKey =  "Your Places key"
    }
